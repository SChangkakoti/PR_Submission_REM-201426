export class ValidationsHelper {
    ...
    static getNotSelectedValidation(name: string) {
        return `${name} should not be selected`;
    }
    ...
    static getFieldClearValidation(label: string) {
        return `${this.types.field} ${label} should be clear`;
    }
    ...
    static getAlertNotDisplayedValidation() {
        return 'Alert should not be displayed';
    }

    static getAlertDisplayedValidation() {
        return 'Alert should be displayed';
    }

    static getStringToContainInArray(actualValue: string, ...expectedValue: string[]) {
        return `${actualValue} should contain one of ${expectedValue.toString()}`;
    }

    static getNoAlertDisplayedValidation() {
        return 'No alert should be displayed';
    }
}
